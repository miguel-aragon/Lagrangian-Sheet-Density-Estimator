...
int main(int argc, char **argv)
{
  ...
  //--- Compute densities
  get_densities(ng, nx,ny,nz, cube);
...
void get_densities(int ng, int nx, int ny, int nz, float **cube){
  ...
  #pragma omp parallel
  {
	...
	for (long i=0; i<ng; i++) {
	  ...
	  ind[0][0] = i     + ng*j     + ng2*k;
	  ind[0][1] = i     + ng*(j+1) + ng2*k;
	  ind[0][2] = i     + ng*j     + ng2*(k+1);
	  ind[0][3] = (i+1) + ng*j     + ng2*(k+1);
	  
	  ind[1][0] = i     + ng*j     + ng2*k;
	  ind[1][1] = i     + ng*(j+1) + ng2*k;
	  ind[1][2] = (i+1) + ng*j     + ng2*(k+1);
	  ind[1][3] = (i+1) + ng*j     + ng2*k;
	  
	  ind[2][0] = i     + ng*j     + ng2*(k+1);
	  ind[2][1] = i     + ng*(j+1) + ng2*(k+1);
	  ind[2][2] = (i+1) + ng*j     + ng2*(k+1);
	  ind[2][3] = i     + ng*(j+1) + ng2*k;
	  
	  ind[3][0] = i     + ng*(j+1) + ng2*k;
	  ind[3][1] = (i+1) + ng*j     + ng2*(k+1);
	  ind[3][2] = (i+1) + ng*(j+1) + ng2*(k+1);
	  ind[3][3] = i     + ng*(j+1) + ng2*(k+1);
	  
	  ind[4][0] = i     + ng*(j+1) + ng2*k;
	  ind[4][1] = (i+1) + ng*j     + ng2*(k+1);
	  ind[4][2] = (i+1) + ng*(j+1) + ng2*(k+1);
	  ind[4][3] = (i+1) + ng*(j+1) + ng2*k;
	  
	  ind[5][0] = i     + ng*(j+1) + ng2*k;
	  ind[5][1] = (i+1) + ng*j     + ng2*(k+1);
	  ind[5][2] = (i+1) + ng*(j+1) + ng2*k;
	  ind[5][3] = (i+1) + ng*j     + ng2*k;	   
